...
**31 first-party blog posts · 40 research papers · 17 active GitHub projects**
...
| [Papers / Harness](#papers--harness) | Paper | 13 |
| [Papers / Models](#papers--models) | Paper | 19 |
| [Papers / Theory and Evaluation](#papers--theory-and-evaluation) | Paper | 8 |
| [GitHub / Models / Training Research](#github--models--training-research) | GitHub project | 3 |
...
| --- | --- | ---: | --- | --- |
| autoresearch | [GitHub](https://github.com/karpathy/autoresearch) | [![star: 96,420](https://img.shields.io/badge/star-96420-f4b400?style=flat-square)](https://github.com/karpathy/autoresearch) | `model-training`<br>`experiment-loop`<br>`validation` | **Bounded optimization**<br>An AI agent autonomously modifies a small LLM training script, runs 5-minute experiments on a single GPU, evaluates validation loss, and keeps or discards each change before proposing the next modification.<br><details open><summary>Boundary</summary>The agent modifies an external training target, not its own weights or improvement procedure. The single-file experiment loop and 5-minute budget constrain what can be explored. Repository maintenance stalled after 2026-03-26 with 185+ open issues and PRs unaddressed; community forks remain active.</details><br>• [Evidence](https://github.com/karpathy/autoresearch/blob/master/README.md) |
...
| Project | Link | Stars | Tags | Improvement Loop and Boundary |
| --- | --- | ---: | --- | --- |
| Hermes Agent / Learned Skills | [GitHub](https://github.com/NousResearch/hermes-agent) | [![star: 247,403](https://img.shields.io/badge/star-247403-f4b400?style=flat-square)](https://github.com/NousResearch/hermes-agent) | `learned-skills`<br>`procedural-memory`<br>`experience` | **Experience learning**<br>Creates procedural skills after complex tasks and revises them during use; persistent skills and searchable experience are reused across sessions.<br><details open><summary>Boundary</summary>This is experience-driven skill persistence, not model-weight training or independently demonstrated monotonic capability growth.</details><br>• [Evidence](https://github.com/NousResearch/hermes-agent) |
