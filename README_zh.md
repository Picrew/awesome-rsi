...
**31 篇一手博客 · 45 篇研究论文 · 15 个活跃 GitHub 项目**
...
| [论文 / Harness](#papers--harness) | 论文 | 15 |
| [论文 / Models](#papers--models) | 论文 | 21 |
| [论文 / 理论与评测](#papers--theory-and-evaluation) | 论文 | 9 |
| [GitHub / Models / 训练研究](#github--models--training-research) | GitHub 项目 | 2 |
...
| [GitHub / Harness / 提示与工作流优化](#github--harness--prompt-and-workflow-optimization) | GitHub 项目 | 5 |
| [GitHub / Artifacts / 程序进化](#github--artifacts--program-evolution) | GitHub 项目 | 1 |
...
- Star 徽章与推送日期来自 **2026-09-20** 的元数据快照。
...
| 论文 | 改进机制 | 代码 |
| --- | --- | --- |
| **[SIFT](https://arxiv.org/abs/2609.19526)**<br>2026-09-17 | **直接自修改**<br>结合 LLM 成对评判与基准分数选择父代、安排评测，进化编码代理实现；归档后代继续作为代码修订起点。实验包含 DGM/HGM 基线、评判器消融和跨编码模型迁移。<br><details open><summary>边界</summary>模型权重及搜索、评判流程固定，仍依赖更强外部评判器与基准检查。完整基准包含搜索子集，并非完全独立的留出评测。成本表为单次运行结果，修改评测器的越界补丁会被拒绝。</details> | — |
| **[Dream-RSI](https://arxiv.org/abs/2609.14858)**<br>2026-09-14 | **直接自修改**<br>利用发现历史的回放修订可执行探索策略，再部署新策略收集后续改进数据。实验在算法、数学和内核任务上对照固定探索策略，并包含留出的 Lasso 数据集。<br><details open><summary>边界</summary>修改仅限探索控制；发现模型、策略开发模型、评测器和接口保持固定。回放只覆盖已有结果；回放分数不下降不保证在线改进，各任务收益不同。完整实现尚未发布。</details> | [仅&#8288;官&#8288;方&#8288;产&#8288;物](https://github.com/zhengkid/Dream-RSI)<br>[![star: 957](https://img.shields.io/badge/star-957-f4b400?style=flat-square)](https://github.com/zhengkid/Dream-RSI)<br><details open><summary>详情</summary>• **最近推送:** 2026-09-16<br>• 作者关联仓库目前包含论文与展示材料。README 将完整代码库、发现程序的发布及复现脚本列为待发布，不属于可运行的实现发布。</details> |
| **[Meta^n](https://arxiv.org/abs/2608.24735)**<br>2026-08-25 | **直接自修改**<br>对演化中的求解器栈反复应用固定元操作，生成预处理代码与可复用辅助函数，并以档案保留已评测的层链。<br><details open><summary>边界</summary>递归作用于生成的层，而非元操作或模型权重；论文多数收益来自层间上下文传递，运行在有限深度停滞。</details> | [官&#8288;方&#8288;代&#8288;码](https://github.com/minnesotanlp/meta-n)<br>[![star: 30](https://img.shields.io/badge/star-30-f4b400?style=flat-square)](https://github.com/minnesotanlp/meta-n)<br><details open><summary>详情</summary>• **最近推送:** 2026-08-26<br>• 作者将该实现标为研究原型，结果属探索性质。</details> |
| **[HELIX](https://arxiv.org/abs/2608.13951)**<br>2026-08-14 | **直接自修改**<br>将代理系统分解为类型化模块组件，在闭环中联合进化 harness 与模型；harness 进化提升当前表现，同时生成经过验证的轨迹作为下一轮模型更新的训练数据。<br><details open><summary>边界</summary>仅在代码修复任务上评测。65 候选组合和 200 槽位同胞切片定义搜索预算。模型-harness 联合进化展示在有界迭代内，未证明无限改进。</details> | [官&#8288;方&#8288;代&#8288;码](https://github.com/HKUDS/HELIX)<br>[![star: 41](https://img.shields.io/badge/star-41-f4b400?style=flat-square)](https://github.com/HKUDS/HELIX)<br><details open><summary>详情</summary>• **最近推送:** 2026-08-17</details> |
...
| 论文 | 改进机制 | 代码 |
| --- | --- | --- |
| **[ScienceBuddy](https://arxiv.org/abs/2609.17523)**<br>2026-09-15 | **自训练**<br>交替执行反馈驱动的 harness 修订与任务模型 GRPO 训练，更新权重和选中 harness 进入后续循环。三轮科学任务实验报告单次尝试测试准确率从 42.2% 提升至 73.3%。<br><details open><summary>边界</summary>辅助编辑模型、评分准则生成器和评测器固定；结果限于源自研究者交互的任务与三轮实验。公开简化实验的阶段预算不同于论文，未包含托管产品，也未证明开放式科学能力增长。</details> | [官&#8288;方&#8288;代&#8288;码](https://github.com/Gen-Verse/ScienceBuddy)<br>[![star: 75](https://img.shields.io/badge/star-75-f4b400?style=flat-square)](https://github.com/Gen-Verse/ScienceBuddy)<br><details open><summary>详情</summary>• **最近推送:** 2026-09-17<br>• 论文链接的 ScienceBuddy-RSI 重定向至此规范仓库。README 与 docs/algorithm.md 描述冻结任务的三轮简化发布，每阶段三步 harness 搜索和 30 次 GRPO 更新，不同于论文的十步搜索、20 次更新实验；不含托管产品源码。</details> |
| **[J-Zero](https://arxiv.org/abs/2608.26582)**<br>2026-08-27 | **自训练**<br>跨轮共同训练出题者、求解者和评判者；以结构化构造的偏好对更新评判者，再用其奖励指导后续策略训练。<br><details open><summary>边界</summary>评判者从预训练奖励模型开始；偏好次序是人为设计的假设，报告的十轮收益不代表无界改进。</details> | [官&#8288;方&#8288;代&#8288;码](https://github.com/GyoukChu/J-Zero)<br>[![star: 10](https://img.shields.io/badge/star-10-f4b400?style=flat-square)](https://github.com/GyoukChu/J-Zero)<br><details open><summary>详情</summary>• **最近推送:** 2026-09-10</details> |
...
| **[Self-Guided Self-Play (SGS)](https://arxiv.org/abs/2604.20209)**<br>2026-04-22 | **自训练**<br>用经 Lean4 验证的证明共同训练求解者与出题者；冻结的引导模型按相关性和清晰度评价合成子题，更新后的模型生成后续题目与解答。长程实验及消融检验出题退化与求解者熵坍塌。<br><details open><summary>边界</summary>依赖固定目标题集与形式验证器，引导模型不参与训练。主要比较是训练期间累计解题率与更大模型 pass@4，并非同预算的独立测试准确率。拟合渐近值属于外推，尚未验证不可形式验证的领域。</details> | [官&#8288;方&#8288;代&#8288;码](https://github.com/LukeBailey181/sgs)<br>[![star: 82](https://img.shields.io/badge/star-82-f4b400?style=flat-square)](https://github.com/LukeBailey181/sgs)<br><details open><summary>详情</summary>• **最近推送:** 2026-04-26<br>• 作者关联实现包含完整 SGS、冻结出题者及无引导模型消融脚本。standard_sgs.py 保留两类模型的训练结果，full_pipeline.py 管理连续轮次 checkpoint；本轮未复现实验。</details> |
| **[Agent0](https://arxiv.org/abs/2511.16043)**<br>2025-11-20 | **自训练**<br>将课程模型与使用工具的执行模型耦合；更强执行能力推动生成更难课程，课程再提供强化学习数据。<br><details open><summary>边界</summary>公开训练指南需要人工选择轮次间 checkpoint；零外部数据也未消除对预训练基础模型和工具的依赖。</details> | [官&#8288;方&#8288;代&#8288;码](https://github.com/aiming-lab/Agent0)<br>[![star: 1,263](https://img.shields.io/badge/star-1263-f4b400?style=flat-square)](https://github.com/aiming-lab/Agent0)<br><details open><summary>详情</summary>• **最近推送:** 2026-07-10</details> |
| **[R-Zero](https://arxiv.org/abs/2508.05004)**<br>2025-08-07<br>[ICLR 2026](https://github.com/Chengsong-Huang/R-Zero/blob/main/README.md) | **自训练**<br>共同进化 Challenger 与 Solver 模型，以能力边界附近的生成任务训练 Solver，而 Solver 能力变化又改变 Challenger 的奖励。<br><details open><summary>边界</summary>使用预训练基础模型与人工设计奖励；有限迭代可能退步，作者后续 R-Few 工作引入人工数据以应对扩展限制。</details> | [官&#8288;方&#8288;代&#8288;码](https://github.com/Chengsong-Huang/R-Zero)<br>[![star: 850](https://img.shields.io/badge/star-850-f4b400?style=flat-square)](https://github.com/Chengsong-Huang/R-Zero)<br><details open><summary>详情</summary>• **最近推送:** 2026-02-04</details> |
| **[Self-Adapting Language Models (SEAL)](https://arxiv.org/abs/2506.10943)**<br>2025-06-12 | **自训练**<br>模型生成包含微调数据或更新指令的自编辑内容；SFT 产生持久权重变化，下游性能通过外层 RL 循环训练更好的自编辑生成能力。<br><details open><summary>边界</summary>自编辑在研究者设计的 SFT/RL 框架内控制适配；知识吸收与少样本泛化实验不能证明无约束的自主重设计。</details> | [官&#8288;方&#8288;代&#8288;码](https://github.com/Continual-Intelligence/SEAL)<br>[![star: 1,860](https://img.shields.io/badge/star-1860-f4b400?style=flat-square)](https://github.com/Continual-Intelligence/SEAL)<br><details open><summary>详情</summary>• **最近推送:** 2025-08-01<br>• 论文链接作者项目页，匹配的官方仓库链接同一论文与项目页；规范仓库为 Continual-Intelligence/SEAL。</details> |
| **[Absolute Zero](https://arxiv.org/abs/2505.03335)**<br>2025-05-06 | **自训练**<br>模型共同进化任务提案与求解能力，利用代码执行器提供任务有效性和答案奖励，而非依赖外部整理的后训练数据集。<br><details open><summary>边界</summary>零数据指自博弈后训练设置，不代表基础模型未经训练；执行器、奖励和优化机制仍由人设计。</details> | [官&#8288;方&#8288;代&#8288;码](https://github.com/LeapLabTHU/Absolute-Zero-Reasoner)<br>[![star: 1,907](https://img.shields.io/badge/star-1907-f4b400?style=flat-square)](https://github.com/LeapLabTHU/Absolute-Zero-Reasoner)<br><details open><summary>详情</summary>• **最近推送:** 2025-08-24</details> |
...
| **[Recursive Code Self-Training Collapse](https://arxiv.org/abs/2606.28438)**<br>2026-06-26 | **评测与安全**<br>在四个代码模型、五轮训练中比较无过滤递归训练、独立编译与静态检查、模型自身审查。自审可能越来越认可自产代码，而基准正确率下降，揭示后续训练反馈失效。<br><details open><summary>边界</summary>主要实验限于 Python 与 1.1B-7B 模型。Human-gate 指简化自动检查，不是真实人工 PR 审查或完整语义验证。有限轮次的坍塌实验不代表所有自训练或更强外部验证必然失败。</details> | [官&#8288;方&#8288;代&#8288;码](https://github.com/Hik289/code-retraining)<br>[![star: 5](https://img.shields.io/badge/star-5-f4b400?style=flat-square)](https://github.com/Hik289/code-retraining)<br><details open><summary>详情</summary>• **最近推送:** 2026-09-07<br>• 作者关联 src/run_experiment.sh 将上一轮 checkpoint 用于生成、过滤与训练。当前评测命令使用 temperature 0.0，而论文设置写为 0.8；声称复现前需核对配置。</details> |
...
仓库元数据快照：**2026-09-20**。本节只列公开、未归档、最近 **60 天**有 push 的项目；star 是快照，不是 RSI 证据。上方论文配套代码不受活跃窗口限制。
...
| 项目 | 链接 | Stars | 标签 | 改进闭环与边界 |
| --- | --- | ---: | --- | --- |
| J-Zero | [GitHub](https://github.com/GyoukChu/J-Zero) | [![star: 10](https://img.shields.io/badge/star-10-f4b400?style=flat-square)](https://github.com/GyoukChu/J-Zero) | `self-training`<br>`recursive-learning` | **自训练**<br>实现：跨轮共同训练出题者、求解者和评判者；以结构化构造的偏好对更新评判者，再用其奖励指导后续策略训练。<br><details open><summary>边界</summary>评判者从预训练奖励模型开始；偏好次序是人为设计的假设，报告的十轮收益不代表无界改进。</details><br>• [证据](https://github.com/GyoukChu/J-Zero) |
...
| 项目 | 链接 | Stars | 标签 | 改进闭环与边界 |
| --- | --- | ---: | --- | --- |
| DSPy / GEPA and MIPROv2 | [GitHub](https://github.com/stanfordnlp/dspy) | [![star: 38,161](https://img.shields.io/badge/star-38161-f4b400?style=flat-square)](https://github.com/stanfordnlp/dspy) | `prompt-optimization`<br>`demonstrations`<br>`metrics` | **有界优化**<br>针对任务指标优化指令和示例来编译 LM 程序，编译结果保留所选配置供后续使用。<br><details open><summary>边界</summary>仅因其优化器收录，而非 DSPy 的所有功能；提示编译本身不修改优化器或模型权重。</details><br>• [证据](https://github.com/stanfordnlp/dspy/blob/main/dspy/teleprompt/gepa/gepa.py) |
| GEPA | [GitHub](https://github.com/gepa-ai/gepa) | [![star: 6,665](https://img.shields.io/badge/star-6665-f4b400?style=flat-square)](https://github.com/gepa-ai/gepa) | `reflection`<br>`pareto-selection`<br>`prompt-optimization` | **有界优化**<br>反思执行轨迹和评测反馈来提出提示修订，并通过 Pareto 选择保留互补候选。<br><details open><summary>边界</summary>原始方法在固定模型权重下优化提示；通用 optimize_anything API 不代表 GEPA 会改写自身。</details><br>• [证据](https://github.com/gepa-ai/gepa) |
...
| Gear | [GitHub](https://github.com/rsi-gear/gear) | [![star: 42](https://img.shields.io/badge/star-42-f4b400?style=flat-square)](https://github.com/rsi-gear/gear) | `harness-optimization`<br>`execution-feedback`<br>`candidate-selection` | **有界优化**<br>利用执行轨迹与基准评测反馈迭代优化智能体的提示词、工具和工作流，将选中的外壳版本保留供后续轮次使用。<br><details open><summary>边界</summary>公开的五轮外壳实验重复使用公共任务进行优化，不构成独立泛化验证；可配置的搜索组件不等于已实现优化器自主改进，完整的模型训练循环仍在开发中。</details><br>• [证据](https://github.com/rsi-gear/gear#algorithm-design) |
...
| 项目 | 链接 | Stars | 标签 | 改进闭环与边界 |
| --- | --- | ---: | --- | --- |
| Hermes Agent / Learned Skills | [GitHub](https://github.com/NousResearch/hermes-agent) | [![star: 247,407](https://img.shields.io/badge/star-247407-f4b400?style=flat-square)](https://github.com/NousResearch/hermes-agent) | `learned-skills`<br>`procedural-memory`<br>`experience` | **经验学习**<br>在复杂任务后创建过程性技能，并在使用中修订；持久技能与可搜索经验用于后续会话。<br><details open><summary>边界</summary>这是经验驱动的技能持久化，不是模型权重训练，也不是独立证明的单调能力增长。</details><br>• [证据](https://github.com/NousResearch/hermes-agent) |
| GenericAgent | [GitHub](https://github.com/lsdefine/GenericAgent) | [![star: 14,218](https://img.shields.io/badge/star-14218-f4b400?style=flat-square)](https://github.com/lsdefine/GenericAgent) | `skill-learning`<br>`experience-accumulation`<br>`tool-use` | **有界优化**<br>最小化自进化代理，每完成一个任务即结晶为可复用技能，从 3.3K 行种子代码生长持久技能树；积累的技能在后续任务中被检索并组合使用。<br><details open><summary>边界</summary>技能是存储的产物而非自修改代码；代理循环、工具定义和技能结晶过程保持固定。优化器本身不跨轮改变。</details><br>• [证据](https://github.com/lsdefine/GenericAgent) |
