...
The expanded audit includes 31 first-party blogs, 37 papers and 10 active projects. Original publisher content covers Google DeepMind/Research, Anthropic, MiniMax, Moonshot/Kimi, OpenAI/Bain, Sakana AI and Prime Intellect. Papers span self-training, direct self-modification, prompt/workflow evolution, program search and retained skills/playbooks. Thirty-two papers have author-linked code or associated implementations; five have no official code established in reviewed sources. See [dated research decisions](research_decisions.md) and `reports/research/` for provenance and excluded candidates.
